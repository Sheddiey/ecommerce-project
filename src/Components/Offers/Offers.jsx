...
const Offers = () => {
  return (
    <div className="flex p-[50px] bg-linear m-auto w-[85%] h-[60vh] my-[60px] py-[140px]">
      <div className="flex-1 flex flex-col justify-center">
        ...
        <button className="w-[282px] p-[10px] rounded-[33px] text-white bg-red-500 text-[22px] mt-[30px] font-medium cursor-pointer">
          Check Now
        </button>
      </div>
